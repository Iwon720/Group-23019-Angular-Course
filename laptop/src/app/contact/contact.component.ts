...
export class ContactComponent implements OnInit {
  ...
  public onSubmit() {
    ...
    this.httpService.save(this.feedback, this.laptopService.feedbackLink);
  ...
  private createForm() {
    ...
    this.feedbackForm.valueChanges
      .subscribe(() =>
        this.laptopService.onFormValueChanged(this.feedbackForm, this.feedbackFormErrors, this.feedbackValidationMessages));
  }
}
